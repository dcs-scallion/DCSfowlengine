...
fn default_unit_classification() -> FxHashMap<Vehicle, UnitTags> {
    ...
    FxHashMap::from_iter(
        [
            ...
            ("container_cargo".into(), Logistics | Unarmed),
            ("Invisible FARP".into(), Logistics | Unarmed | Invincible),
            ("FARP".into(), Logistics | Unarmed | Invincible),
            ("M-109".into(), Armor | Artillery | Driveable),
            ("Tu-160".into(), Aircraft | CALCM),
    ...
    fn default() -> Self {
        Self {
            ...
            production_factory_units: FxHashSet::from_iter([
                ...
                String::from("Building03_PBR"),
                String::from("Building04_PBR"),
                String::from("Building05_PBR"),
                String::from("Chemical tank A"),
            ...
            warehouse: Some(WarehouseConfig {
                ...
                tick_farp_minimum_global_supply_percentage: 100,
                tick_fob_minimum_global_supply_percentage: 100,
                tick_carrier_minimum_global_supply_percentage: 100,
                tick_airbase_minimum_global_supply_percentage: 100,
                tick_occupiedhub_minimum_global_supply_percentage: 100,
                tick_farp_minimum_airframe_global_supply_percentage: 100,
                tick_fob_minimum_airframe_global_supply_percentage: 100,
                tick_carrier_minimum_airframe_global_supply_percentage: 100,
                tick_airbase_minimum_airframe_global_supply_percentage: 100,
                tick_occupiedhub_minimum_airframe_global_supply_percentage: 100,
                ...
                captured_stock_percentage_ofo: 0,
                captured_stock_percentage_oab: 0,
                captured_stock_percentage_olo: 0,
            }),
            ...
            default_warehouse_ag_bombs: 0,
            default_warehouse_ag_guided_bombs: 0,
            default_warehouse_fueltanks: 0,
            fueltanks_empty: false,
            ...
            jtac_los_unit_aim_m: 2,
            jtac_los_static_aim_m: 10,
            jtac_los_observer_ground_m: 2,
            jtac_los_observer_air_m: -5,
            extra_fixed_wing_objectives: FxHashSet::default(),
            ewr_mode: EwrMode::Original,
            ewr_delay: 60,
            ewr_min_speed_kmh: None,
            ewr_min_ralt_m: None,
            ...
            debugging_objectives_coalition_switch: false,
